...
namespace Tatil_Rezervasyon_Otomasyonu
{
    public partial class admingiris : Form
    {
        ...
        {
            OleDbConnection baglanti = new OleDbConnection("Provider = Microsoft.ACE.OLEDB.12.0; Data Source = C:\\Users\\Merve_Bayram\\Desktop\\yonetici.accdb");
            
            baglanti.Open();
            OleDbCommand giris = new OleDbCommand("select * from yonetici where Ad=@Ad and sifre=@sifre", baglanti);
